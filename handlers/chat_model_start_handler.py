    ...
    def on_chat_model_start(self, serialized, messages, **kwargs):
        ...
        for message in messages[0]:
            if message.type == "system":
                ...
                boxen_print(
                    message.content, title=message.type, color="blue", padding=1
                )

            elif message.type == "function" and message.content is not None:
                boxen_print(
                    message.content,
                    title=message.type,
                    color="purple",
                ...
                boxen_print(message.content, title=message.type, padding=1)
